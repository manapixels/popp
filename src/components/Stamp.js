        ...
        <Tippy content={name}>
            <div className="stamp-container">
                <div className={`stamp ${active ? 'active' : ''}`}>
                    <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-star" width="44" height="44" viewBox="0 0 24 24" stroke-width="1.5" stroke="#000000" fill="none" strokeLinecap="round" strokeLinejoin="round">
